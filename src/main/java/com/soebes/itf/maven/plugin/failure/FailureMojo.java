...
public class FailureMojo extends AbstractMojo {
  ...
  @Parameter(property = "executionException", defaultValue = "false")
  private boolean executionException;

  @Parameter(property = "failureException", defaultValue = "false")
  private boolean failureException;

  @Parameter(property = "exception", defaultValue = "Exception")
